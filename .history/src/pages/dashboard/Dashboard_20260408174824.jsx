...
function Dashboard() {
  ...
  const getMarksReport = async () => {
    ...
    const formatted = {
      ...
      pass: Number(data.pass_count || 0),
      fail: Number(data.fail_count || 0),
      absent: Number(data.absent_count || 0),
    };

    setFormattedMarks(formatted);
  };
        ...
        <div className="section-card">
          ...
          {formattedMarks && (
            <div className="marks-grid">
              <div className="card stat"><h4>Average</h4><p>{formattedMarks.average}</p></div>
              <div className="card stat"><h4>Highest</h4><p>{formattedMarks.highest}</p></div>
              <div className="card stat"><h4>Lowest</h4><p>{formattedMarks.lowest}</p></div>
              <div className="card total"><h4>Total</h4><p>{formattedMarks.total}</p></div>
              <div className="card pass"><h4>Pass</h4><p>{formattedMarks.pass}</p></div>
              <div className="card fail"><h4>Fail</h4><p>{formattedMarks.fail}</p></div>
              <div className="card absent"><h4>Absent</h4><p>{formattedMarks.absent}</p></div>
            </div>
          )}
        </div>
      </div>
