        ...
        <div className="section-card">
          ...
          {marksSummary && (
            <div className="marks-grid">
              ...
              <div className="card pass"><h4>Pass</h4><p>{marksSummary.pass_count}</p></div>
              <div className="card fail"><h4>Fail</h4><p>{marksSummary.fail_count}</p></div>
              <div className="card absent"><h4>Absent</h4><p>{marksSummary.absent_count}</p></div>
            </div>
          )}
        </div>
      </div>
